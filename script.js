...
document.getElementById("quoteInput").onkeydown = function(e){    
    ...
    if(e.key === "Backspace"){
        incorrectKeysPress++
        console.log(incorrectKeysPress)
    } else if(!(e.key === "Shift")){
        totalKeysPress ++
    }
}
...
async function renderNewQuote() {
    ...
    quoteInputElement.focus(quoteInputElement)
    startTimer()
}
let startTime 
function startTimer(){
